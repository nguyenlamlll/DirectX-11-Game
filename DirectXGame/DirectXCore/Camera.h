...
namespace DirectXCore
{
	...
	public:
		...
		void SetPosition(DirectX::SimpleMath::Vector3 _pos) { camPosition = _pos; }
		DirectX::SimpleMath::Vector3 GetPosition() { return camPosition; }
		RECT GetBound();
		...
		bool IsContain(DirectX::SimpleMath::Vector3 _objectPosition, DirectX::SimpleMath::Vector3 _objectScale);
